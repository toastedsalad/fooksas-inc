...
public class TableManagerTest {
    ...
    public void WhenTableIsOffSettingOnSetsAGuid() {
        ...
        Assert.That(tableManager.Session.Id, Is.Not.EqualTo(Guid.Empty));
    }
    ...
    public void WhenTableIsOffSettingOnSetsASessionTimer() {
        ...
        Assert.That(tableManager.Session.StartTime.Minute, Is.EqualTo(DateTime.Now.Minute));
    }
    ...
    public void WhenTableIsSetToStandByTheSessionIsStopped() {
        ...
        Assert.That(tableManager.State, Is.EqualTo(TableState.Standby));
        Assert.That(tableManager.Session.IsStopActive, Is.True);
    }
    ...
    public void WhenTableIsSetToOffSessionIsStoppedAndMovedToArchive() {
        ...
        Assert.That(tableManager.State, Is.EqualTo(TableState.Off));
        Assert.That(tableManager.Session, Is.EqualTo(null));
    }
    ...
    public void TableCanRunAndTrackATimedSession() {
        ...
        Assert.That(tableManager.State, Is.EqualTo(TableState.Play));
        Assert.That((int)tableManager.Session.TimedSessionSpan.TotalSeconds, Is.EqualTo(10));
        Assert.That((int)tableManager.Session.GetRemainingPlayTime().TotalSeconds, Is.EqualTo(10));

        fakeTimer.TriggerElapsed();
        fakeTimer.TriggerElapsed();
        Assert.That((int)tableManager.Session.GetRemainingPlayTime().TotalSeconds, Is.EqualTo(8));
    }
    ...
    public void WhenTableStopsTimedSessionPlayTimeDoesntCount() {
        ...
        Assert.That((int)tableManager.Session.GetRemainingPlayTime().TotalSeconds, Is.EqualTo(6));
        Assert.That((int)tableManager.Session.GetPlayTime().TotalSeconds, Is.EqualTo(4));
        Assert.That(tableManager.State, Is.EqualTo(TableState.Play));
        ...
        Assert.That((int)tableManager.Session.GetRemainingPlayTime().TotalSeconds, Is.EqualTo(4));
        Assert.That((int)tableManager.Session.GetPlayTime().TotalSeconds, Is.EqualTo(6));
        Assert.That(tableManager.State, Is.EqualTo(TableState.Play));
    }
    ...
    public void WhenTimedSessionExpiresTableGoesToStandby() {
        ...
        Assert.That((int)tableManager.Session.GetRemainingPlayTime().TotalSeconds, Is.EqualTo(8));
        Assert.That((int)tableManager.Session.GetPlayTime().TotalSeconds, Is.EqualTo(2));
        Assert.That(tableManager.State, Is.EqualTo(TableState.Play));
        ...
        Assert.That((int)tableManager.Session.GetRemainingPlayTime().TotalSeconds, Is.EqualTo(0));
        Assert.That((int)tableManager.Session.GetPlayTime().TotalSeconds, Is.EqualTo(10));
        Assert.That(tableManager.State, Is.EqualTo(TableState.Standby));
    }
}
