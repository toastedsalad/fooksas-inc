...
export default function PlayersPage() {
  ...
  const [newPlayer, setNewPlayer] = useState({ name: "", surname: "", email: "", discount: 0 });
  ...
  const addMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setNewPlayer({ name: "", surname: "", email: "", discount: 0 });
    },
  });
      ...
      <div className="border p-4 rounded bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-700 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <input
            ...
            onChange={(e) =>
              setNewPlayer({ ...newPlayer, discount: parseFloat(e.target.value) || 0 })
            }
          />
        </div>
        <button
